...
I've used prefect for orchestration here!

server tracking : prefect server start

It decides what runs, when it runs, in what order, with what retries, and logs everything so you can see failures, schedule jobs, and automate pipelines.
...
if __name__ == "__main__":
    ...
    #need to provide the year and month while running. 
    #eg: python orchestration_test.py --year = 2025 --month = 1
